...
export const PdfIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
    <path d="M14 2H6c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V8l-6-6zM9.5 13.5c-.83 0-1.5.67-1.5 1.5s.67 1.5 1.5 1.5 1.5-.67 1.5-1.5-.67-1.5-1.5-1.5zm4.75 3.25h-1.5v-4h1.5v4zm-2.25-5.5c.55 0 1 .45 1 1v1.5h-2.5v-2c0-.28.22-.5.5-.5h1zM13 9V3.5L18.5 9H13z"/>
  </svg>
);

export const PptIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
    <path d="M4 3h16c.55 0 1 .45 1 1v16c0 .55-.45 1-1 1H4c-.55 0-1-.45-1-1V4c0-.55.45-1 1-1zm8 10.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5zm-4-4.5H6v1.5h2v-1.5zm0 3H6v1.5h2v-1.5zm0 3H6v1.5h2v-1.5zm10-5h-2.5v6H18V9.5c0-.83-.67-1.5-1.5-1.5z"/>
  </svg>
);

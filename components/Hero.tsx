  ...
  return (
    <section className="container mx-auto px-6 py-20 lg:py-32 flex flex-col items-center text-center">
      ...
      <h1 className="text-5xl lg:text-7xl font-bold mb-8 max-w-4xl leading-tight">
        Fusionando <span className="gradient-text">IA y Arquitectura</span> para Soluciones Empresariales
      </h1>
      <p className="text-lg lg:text-xl text-zinc-400 max-w-2xl mb-12 leading-relaxed">
        Construyendo soluciones escalables web y de escritorio. Especialista en integración de IA, microservicios con NestJS y ecosistemas React. Transformando procesos complejos en software robusto y eficiente.
      </p>
